...
function QuestionnaireContent() {
                    ...
                    <div className="text-center">
                        <div className="mb-8 flex justify-center">
                            <div className="bg-yellow-100 p-8 rounded-full">
                                <FileText className="w-16 h-16 text-yellow-500 animate-pulse"/>
                            </div>
                        </div>
    ...
    // If user is logged in and NO SSN in route, show questionnaire with full layout (sidebar)
    if (isLoggedIn) {
        return <InvestmentQuestionnaireScreen standalone={false} initialSsn={""} />;
    }

    // If user is NOT logged in and no SSN provided, show SSN required message
    // This should never happen now since we handle SSN cases above, but keeping as fallback
    return (
        <MainLayout hideSidebar={true}>
            <div className="min-h-screen bg-white flex flex-col">
                {/* Content */}
